...
//    fn patch_object(identifier_1: &str, identifier_2: &str, identifier_3: &str, key_to_patch: &str, value_to_patch: &str, core: &mut Core, apiclient: &APIClient<HttpsConnector<HttpConnector>>) -> Result<(), &'static str> {
//        unimplemented!()
//    }

    // change the enabled state fo a object
    fn enabled(identifier_1: &str, identifier_2: &str, selector: Vec<&str>, state: bool, core: &mut Core, apiclient: &APIClient<HttpsConnector<HttpConnector>>) -> Result<(), &'static str> {
        unimplemented!()
    }
